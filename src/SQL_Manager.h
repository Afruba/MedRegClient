...
void get_row_data_from_Htbl	(QStringList& buf, short table_id, QString column_name, QString object_id, pqxx::connection *cx);
...
void get_all_date_schedules(QStringList &buf, pqxx::connection *cx, bool check_status=false);
